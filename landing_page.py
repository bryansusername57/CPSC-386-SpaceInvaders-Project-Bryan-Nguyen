...
class LandingPage:
    ...
    alien_one_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien__0{n}.png'), 0, 2) for n in range(2)]
    alien_two_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien__1{n}.png'), 0, 2) for n in range(2)]
    alien_three_imgs = [pg.transform.rotozoom(pg.image.load(f'images/alien__2{n}.png'), 0,2) for n in range(2)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/ufo__{n}.png'), 0, 5) for n in range(2)]
